...
{
    KOAN_EQ_SZ(__SZ, sizeof(char));
    KOAN_EQ_SZ(__SZ, sizeof(signed char));
    KOAN_EQ_SZ(__SZ, sizeof(unsigned char));
}
...
{
    KOAN_EQ_SZ(__SZ, sizeof(int8_t));
    KOAN_EQ_SZ(__SZ, sizeof(int16_t));
    KOAN_EQ_SZ(__SZ, sizeof(int32_t));
    KOAN_EQ_SZ(__SZ, sizeof(int64_t));
}
...
{
    KOAN_EQ_INT(__, SCHAR_MAX);
    KOAN_EQ_INT(__, SCHAR_MIN);

    /* The asymmetry, stated generally: */
    KOAN_TRUE(INT_MIN + INT_MAX == __);
}
