...
KOAN_DELIBERATE_END
    ...
    KOAN_EQ_STR(/*__STR*/ "a but not b", result);
}
...
KOAN(do_while_always_runs_once)
{
    ...
    KOAN_EQ_INT(/*__*/ 0, while_runs);
    KOAN_EQ_INT(/*__*/ 1, do_runs);
}
...
KOAN(break_and_continue_affect_the_innermost_loop)
{
    ...
    KOAN_EQ_INT(/*__*/ 6, inner_iterations);
}
...
KOAN(switch_grouping_and_default)
{
    ...
    KOAN_EQ_INT(/*__*/ 2, letters);
    KOAN_EQ_INT(/*__*/ 1, digits);
    KOAN_EQ_INT(/*__*/ 1, other);
}
...
KOAN(goto_unwinds_error_paths)
{
    ...
    KOAN_EQ_INT(/*__*/ 0, acquire_three(false, &unwound));
    KOAN_EQ_INT(/*__*/ 0, unwound);

    KOAN_EQ_INT(/*__*/ -1, acquire_three(true, &unwound));
    KOAN_EQ_INT(/*__*/ 0, unwound);
}
