...
KOAN(c_can_calculate)
{
    ...
    KOAN_EQ_INT(/*__*/ 10, 4 + 6);
    KOAN_EQ_INT(/*__*/ 2, 8 - 6);
}
...
{
    KOAN_EQ_STR(/*__STR*/ "hello", "hello");
    KOAN_EQ_STR(/*__STR*/ "two words", "two words");
}
...
KOAN(the_types_you_have_met)
{
    KOAN_EQ_INT(/*__*/ 1, 1);
    KOAN_TRUE(/*__BOOL*/ true);
    KOAN_EQ_CHR(/*__CHR*/ 'c', 'c');
    KOAN_EQ_STR(/*__STR*/ "text", "text");
}
...
{
    KOAN_EQ_INT(/*__*/ 4, 2 + 2);
    KOAN_EQ_INT(/*__*/ 8, 4 * 2);
    KOAN_TRUE(2 + 2 == /*__*/ 4);
    KOAN_FALSE(4 * 2 == /*__*/ 9);
}
