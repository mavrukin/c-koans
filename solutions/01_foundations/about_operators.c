...
{
    KOAN_EQ_INT(/*__*/ 14, 2 + 3 * 4);
    KOAN_EQ_INT(/*__*/ 20, (2 + 3) * 4);
...
KOAN_DELIBERATE_BEGIN
    KOAN_EQ_INT(/*__*/ 0, flags & 0b0100 == 0b0100);
    KOAN_EQ_INT(/*__*/ 32, 1 << 2 + 3);
KOAN_DELIBERATE_END
    KOAN_EQ_INT(/*__*/ 4, (flags & 0b0100) == 0b0100 ? 4 : 0);
}
...
KOAN(bitwise_operators_work_on_representation)
{
    ...
    KOAN_EQ_INT(/*__*/ 0b1000, a & b);
    KOAN_EQ_INT(/*__*/ 0b1110, a | b);
    KOAN_EQ_INT(/*__*/ 0b0110, a ^ b);

    /* Complement flips every bit, including the ones you forgot about. */
    unsigned char narrow = 0b00001111;
    KOAN_EQ_INT(/*__*/ 0b11110000, (unsigned char)~narrow);
}
...
{
    KOAN_EQ_INT(/*__*/ 1000000, 1'000'000);
    KOAN_EQ_INT(/*__*/ 255, 0b1111'1111);
}
...
KOAN(logical_operators_short_circuit)
{
    ...
    KOAN_EQ_INT(/*__*/ 0, side_effect_count);
    KOAN_EQ_INT(/*__*/ 0, calls);
...
KOAN(short_circuit_guards_dereference)
{
    ...
    KOAN_EQ_INT(/*__*/ 0, starts_with_k);

    maybe = "koan";
    starts_with_k = (maybe != nullptr && maybe[0] == 'k');
    KOAN_EQ_INT(/*__*/ 1, starts_with_k);
}
...
KOAN(assembling_a_bitfield_extractor)
{
    ...
    KOAN_EQ_INT(/*__*/ 0xD, extract_bits(word, 3, 0));
    KOAN_EQ_INT(/*__*/ 0xA, extract_bits(word, 7, 4));
    KOAN_EQ_INT(/*__*/ 0xAD, extract_bits(word, 7, 0));
    KOAN_EQ_INT(/*__*/ 0xDE, extract_bits(word, 15, 8));

    /* One bit at a time: is bit 0 set? */
    KOAN_EQ_INT(/*__*/ 1, extract_bits(word, 0, 0));
    KOAN_EQ_INT(/*__*/ 0, extract_bits(word, 1, 1));
}
