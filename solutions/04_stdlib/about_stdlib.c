...
KOAN(system_asks_the_shell)
{
    ...
    KOAN_EQ_INT(/*__*/ 0, system("exit 0"));
...
KOAN(allocation_lives_in_stdlib_too)
{
    ...
    KOAN_EQ_SZ(/*__SZ*/ 0, (size_t)((uintptr_t)aligned % 64));
    free(aligned);
}
